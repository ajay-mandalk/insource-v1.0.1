import '../gaming_screen/widgets/viewhierarchy_item_widget.dart';
import 'models/viewhierarchy_item_model.dart';
import 'notifier/gaming_notifier.dart';
...
class GamingScreen extends ConsumerStatefulWidget {
  const GamingScreen({Key? key})
      : super(
          key: key,
        );

  @override
  GamingScreenState createState() => GamingScreenState();
}

class GamingScreenState extends ConsumerState<GamingScreen> {
  @override
