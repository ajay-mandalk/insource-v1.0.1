...
class ComponenttwoItemWidget extends StatelessWidget {
  ComponenttwoItemWidget(
    this.componenttwoItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  ComponenttwoItemModel componenttwoItemModelObj;
          ...
          child: Row(
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: 3.v),
                child: Text(
                  componenttwoItemModelObj.text1!,
                  style: TextStyle(
